...
const serial: string[] = ["00M09A342600271", "00M09A342600260", "00M09C431500177", 
"00M09C431903549", "00M09C431903109", "00M09C411300736", "00M09C412401291", "00M09A381800295",
"00M09A381601473", "00M00A2C0603600","00M09A381800295", "00M09A351803089",  "00M09C431501094"];
  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', marginRight:1}}>
      <Box sx={{ width: '100%', mr: 1}}>
        <LinearProgress className="loadingBar" sx={{height: 20}} variant="determinate" {...props} />
      </Box>
      <Box sx={{ minWidth: 35 }}>
        <Typography variant="body2" color="white" fontSize={20}>{`${props.value}%`}</Typography>
      </Box>
    </Box>
  );
};
...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <Box sx={{flexGrow:1}}>
        <Grid margin={0} container spacing={{ xs: 2, md: 3 }} columns={{ xs: 4, sm: 8, md: 12 }}>
            ...
            <Grid xs={2} sm={4} md={4} >
                <div id={`main-${printerArray?.error}`} className="box">
                  <div className="innerContainer">
                    ...
                    <p>Status: {printerArray?.error === '0' ? 'OK' : (printerArray?.error === "117473284") ? "Spagetti" : "ERROR CODE: " + printerArray?.error }</p>
                    ...
                    <div className="time">
                      <p>Time Remaining:</p><p style={{fontSize:20, paddingLeft:4}}>{printerArray.timeLeft}</p>
                    </div>
                    <Box sx={{ width: '100%' }}>
